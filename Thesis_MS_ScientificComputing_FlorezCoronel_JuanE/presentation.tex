...
%%%% 33
%\begin{frame}{Intellectual Merit}
%\begin{itemize}
%\item The \acrfull{bfast} algorithm is an innovative procedure in the area of 
...
%\subsection{\gls{bfast} Algorithm}
...
\begin{figure}
\centering
\includegraphics[width=0.99\textwidth]{images/dMatSimEx.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{images/activeBOLD.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{images/inactiveBOLD.png}
...
\begin{figure}
\centering
\includegraphics[width=0.99\textwidth]{images/plot3dSimActPr2.png}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{images/dMatEx.png}
...
\begin{figure}
\centering
\includegraphics[width=0.99\textwidth]{images/plot3dActFinalNuevo.png}
\caption{Activation Regions Identified by \gls{bfast}}
\end{figure}
\end{frame}
